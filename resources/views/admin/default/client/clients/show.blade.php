                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($project->cancel_status == 1)
                                                    <span
                                                        class="badge badge-inline badge-danger">{{ translate('Canceled') }}</span>
                                                @elseif($project->closed == 1)
                                                    <span
                                                        class="badge badge-inline badge-success">{{ translate('Completed') }}</span>
                                                @elseif($project->biddable == 0)
                                                    <span
                                                        class="badge badge-inline badge-success">{{ translate('Running') }}</span>
                                                @else
                                                    <span
                                                        class="badge badge-inline badge-secondary">{{ translate('Open') }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
