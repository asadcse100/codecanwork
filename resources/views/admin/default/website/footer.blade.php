                                        ...
                                        <div class="col-sm-12 mb-4">
                                            <div class="input-group  mb-3 required">
                                                ...
                                                <input type="file" name="footer_logo"
                                                    ...
                                                    value="{{ App\Models\SystemConfiguration::where('type', 'footer_logo')->first()->value }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mb-4">
                                            <div class="input-group  mb-3 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">About
                                                    description</span>
                                                <textarea class="aiz-text-editor form-control" name="about_description_footer"
                                                    data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]'
                                                    placeholder="Type.." data-min-height="150">@php
                                            ...
                                            <div class="col-sm-12 mb-4">
                                                <div class="input-group  mb-3 required">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Widget title"
                                                        name="widget_one"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'widget_one')->first()->value }}">
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="{{ json_decode(App\Models\SystemConfiguration::where('type', 'widget_one_links')->first()->value, true)[$key] }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <button type="button"
                                    ...
                                    <form action="{{ route('system_configuration.update') }}" method="POST"
                                        ...
                                        <div class="col-sm-12 mb-4">
                                            <div class="input-group  mb-3 required">
                                                ...
                                                <input type="text" class="form-control" placeholder="Widget title"
                                                    name="widget_two"
                                                    value="{{ App\Models\SystemConfiguration::where('type', 'widget_two')->first()->value }}">
                                            </div>
                                        </div>
                                                    ...
                                                    @foreach (json_decode(App\Models\SystemConfiguration::where('type', 'widget_two_labels')->first()->value, true) as $key => $value)
                                                        <div class="row gutters-5">
                                                            <div class="col-4">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Label" name="widget_two_labels[]"
                                                                        value="{{ $value }}">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ json_decode(App\Models\SystemConfiguration::where('type', 'widget_two_links')->first()->value, true)[$key] }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                                <button type="button"
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('system_configuration.update') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Widget title"
                                                    name="social_widget_title"
                                                    value="{{ App\Models\SystemConfiguration::where('type', 'social_widget_title')->first()->value }}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="facebook_link"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'facebook_link')->first()->value }}">
                                                </div>
                                                <div class="input-group form-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="twitter_link"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'twitter_link')->first()->value }}">
                                                </div>
                                                <div class="input-group form-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="instagram_link"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'instagram_link')->first()->value }}">
                                                </div>
                                                <div class="input-group form-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="youtube_link"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'youtube_link')->first()->value }}">
                                                </div>
                                                <div class="input-group form-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i
                                                    ...
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="linkedin_link"
                                                        value="{{ App\Models\SystemConfiguration::where('type', 'linkedin_link')->first()->value }}">
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <button type="submit"
                        ...
                        <form action="{{ route('system_configuration.update') }}" method="POST"
                            ...
                            <div class="form-group">
                                <label class="form-label"
                                    for="signinSrEmail">{{ translate('Show Language Switcher?') }}</label>
                                <div>
                                    <label class="aiz-switch mb-0">
                                        ...
                                        <input type="checkbox" name="language_switcher"
                                            @if (App\Models\SystemConfiguration::where('type', 'language_switcher')->first()->value == 'on') checked @endif>
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="aiz-text-editor form-control" name="copyright_text"
