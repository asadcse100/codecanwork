                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="aiz-text-editor form-control"
                            ...
                            placeholder="Type.." data-min-height="150" name="slider_section_subtitle">
						@php
            ...
            <form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control resize-off" placeholder="{{ translate('Type..') }}"
                            name="featured_category_subtitle">@php
                ...
                <div class="card-header">
                    ...
                    <div>
                        <label class="aiz-switch mb-0">
                            ...
                            <input type="checkbox" name="cta_section_show"
                                @if (App\Models\SystemConfiguration::where('type', 'cta_section_show')->first()->value == 'on') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}"
                            ...
                            value="{{ App\Models\SystemConfiguration::where('type', 'cta_section_title')->first()->value }}">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Sub title') }}</label>
                        <input type="hidden" name="types[]" value="cta_section_subtitle">
                        <textarea class="form-control resize-off" placeholder="{{ translate('Type..') }}" name="cta_section_subtitle">@php
