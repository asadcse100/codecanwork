        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="widget-content widget-content-area layout-top-spacing">
                ...
                <form id="add_form" class="form-horizontal  needs-validation"
                    action="{{ route('staffs.update', $staff->id) }}" method="POST" novalidate
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0">
                            <div class="widget-content widget-content-area blog-create-section">
                                <div class="col-md-6 layout-top-spacing p-2">
                                    <h4 class="mb-md-0 h6">{{ translate('Update Employee Information') }}</h4>
                                </div>
                                <hr>
                                <div class="">
                                        ...
                                        <div class="col-sm-6 mb-4">
                                            <div class="input-group mb-3 required">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    placeholder="{{ translate('Employee Name') }}"
                                        ...
                                        <div class="col-sm-6 mb-4">
                                            <div class="input-group  mb-3 required">
                                                ...
                                                <input type="email" lang="en" class="form-control" name="email"
                                                    placeholder="Employee Email" value="{{ $staff->user->email }}" required>
                                                <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 p-2" style="text-align:right;">
                                    ...
                                    <button type="submit" class="btn btn-outline-success mb-2 me-4">Update</button>
