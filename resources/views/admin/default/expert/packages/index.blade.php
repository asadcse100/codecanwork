                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button style="float: right;" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg"
                                class="btn btn-outline-info">Create Package</button>
                        </div>
                    </div>
                </nav>
            </div>
                                                ...
                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0">
                                                    <div class="widget-content widget-content-area blog-create-section">
                                                        <div class="col-md-3   layout-top-spacing">
                                                            <h5 class="mb-md-0 h6">{{ translate('Create New Package') }}
                                                            </h5>
                                                        </div>
                                                        <form class="form-horizontal" action="{{ route('package.store') }}"
                                                                        ...
                                                                        <div class="row layout-top-spacing p-4">
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        ...
                                                                                        for="validationCustom01">Package
                                                                                        Name</span>
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Validate
                                                                                        For</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1" id="number_of_days"
                                                                                        name="number_of_days" required
                                                                                        placeholder="{{ translate('Eg. 30') }}"
                                                                                        class="form-control form-control-sm">
                                                                                    {{-- <small
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    ...
                                                                                    <input type="number" min="1"
                                                                                        step="1" id="commission"
                                                                                        name="commission" required
                                                                                        placeholder="{{ translate('Eg. 5') }}"
                                                                                        class="form-control form-control-sm">
                                                                                    {{-- <small
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Commision
                                                                                        Type</span>
                                                                                    <select
                                                                                        class="select2 form-select aiz-selectpicker"
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Fixed
                                                                                        Projects</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1" id="fixed_limit"
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Long Term
                                                                                        Projects</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1"
                                                                                        id="long_term_limit"
                                                                                        name="long_term_limit" required
                                                                            ...
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Skill
                                                                                        Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1"
                                                                                        id="skill_add_limit"
                                                                                        name="skill_add_limit" required
                                                                                        placeholder="Skill Adding Limit"
                                                                                        class="form-control form-control-sm">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Portfolio
                                                                                        Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1"
                                                                                        id="portfolio_add_limit"
                                                                                        name="portfolio_add_limit" required
                                                                                        placeholder="Portfolio Adding Limit"
                                                                                        class="form-control form-control-sm">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Bio
                                                                                        Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1" id="bio_text_limit"
                                                                                        name="bio_text_limit" required
                                                                                        placeholder="Bio Word Limit"
                                                                                        class="form-control form-control-sm">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Project
                                                                                        Bookmark Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1"
                                                                                        id="project_bookmark_limit"
                                                                                        name="project_bookmark_limit"
                                                                                        placeholder="Project Bookmark Limit"
                                                                                        class="form-control form-control-sm">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Job
                                                                                        Experience Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1"
                                                                                        id="job_experience_limit"
                                                                                        name="job_experience_limit"
                                                                                        required
                                                                                        placeholder="Job Experience Limit"
                                                                                        class="form-control form-control-sm">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 mb-2">
                                                                                <div class="input-group mb-3 required">
                                                                                    <span class="input-group-text"
                                                                                        id="inputGroup-sizing-sm"
                                                                                        for="validationCustom01">Service
                                                                                        Limit</span>
                                                                                    <input type="number" min="0"
                                                                                        step="1" id="service_limit"
                                                                                        name="service_limit" required
                                                                            ...
                                                                            <div class="form-group mb-3">
                                                                                ...
                                                                                <div>
                                                                                    <label
                                                                                        class="aiz-switch aiz-switch-success mb-0">
                                                                                        <input type="checkbox"
                                                                                            checked="checked"
