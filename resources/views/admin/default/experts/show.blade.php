                ...
                <div class="card-body text-center">
                    ...
                    <div class="mt-5 text-left">
                        <h6 class="separator mb-4 text-left"><span
                                class="bg-white pr-3">{{ translate('Verification') }}</span></h6>
                    ...
                    <div class="card-body">
                        <div class="text-left">
                            ...
                            <p class="text-muted"><strong>{{ translate('Bank Account Name') }} :</strong><span
                                    class="ml-2">{{ $user_account->bank_acc_name }}</span></p>

                            <p class="text-muted"><strong>{{ translate('Bank Account Number') }} :</strong><span
                                    class="ml-2">{{ $user_account->bank_acc_no }}</span></p>
                        ...
                        @foreach ($user->workExperiences as $key => $user_work_exp)
                            <div class="text-left">
                                ...
                                @if ($user_work_exp->present == '1')
                                    <p class="text-muted text-capitalize"><strong>{{ translate('Leaving Date') }}
                                            :</strong>
