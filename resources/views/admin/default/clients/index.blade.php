                                ...
                                <td class="text-right">
                                    @if ($client->user != null)
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm btn icon"
                                            href="{{ route('client_info_show', $client->user->user_name) }}"
                                    ...
                                    @can('expert_delete')
                                        @if ($client->user->banned)
                                            <a href="javascript:void(0)"
                                                class="btn btn-soft-succss btn-icon btn-circle btn-sm confirm-alert"
                                                data-target="#unban-modal"
                                        ...
                                        @else
                                            <a href="javascript:void(0)"
                                                class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-alert"
                                                data-target="#ban-modal"
                                                data-href="{{ route('user.ban', $client->user->id) }}"
                                                title="{{ translate('Ban') }}">
                                                <i class="las la-ban"></i>
                                            </a>
