                                    ...
                                    <div class="row p-4">
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">MAIL DRIVER</span>
                                                <select class="form-select aiz-selectpicker form-control-sm"
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">MAIL HOST</span>
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">MAIL PORT</span>
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">MAIL
                                                    USERNAME</span>
                                                <input type="text" name="MAIL_USERNAME"
                                                    class="form-control form-control-sm" value="{{ env('MAIL_USERNAME') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                ...
                                                <input type="password" name="MAIL_PASSWORD"
                                                    class="form-control form-control-sm" value="{{ env('MAIL_PASSWORD') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-2">
                                            <div class="input-group mb-2 required">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">MAIL FROM
                                                    ADDRESS</span>
