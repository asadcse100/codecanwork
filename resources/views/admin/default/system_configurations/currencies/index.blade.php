...
@section('content')
    ...
    <div class="layout-px-spacing">
            ...
            {{-- <a href="{{ route('currencies.create') }}" class="btn btn-outline-info mb-2 me-4"
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <div class="row">
                        <div class="col-md-10">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">{{ translate('Add New Currency') }}</li>
                            </ol>
                        </div>
                        <div class="col-md-2">
                            <button style="float:right" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg"
                                class="btn btn-outline-info">{{ translate('Add New Currency') }}</button>
                        </div>
                    </div>
                </nav>
            </div>
