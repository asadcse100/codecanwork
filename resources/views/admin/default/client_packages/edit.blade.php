                    ...
                    <form class="form-horizontal" action="{{ route('package.update', $package->id) }}" method="POST"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="name" name="name" value="{{ $package->name }}" required
                                placeholder="{{ translate('Eg. Bronze Package') }}" class="form-control">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" min="0" step="0.01" id="price" name="price"
                                value="{{ $package->price }}" required placeholder="{{ translate('Eg. 25') }}"
                                class="form-control">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" min="0" step="1" id="number_of_days" name="number_of_days"
                                value="{{ $package->number_of_days }}" required
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" min="0" step="1" id="fixed_limit" name="fixed_limit"
                                value="{{ $package->fixed_limit }}" required placeholder="{{ translate('Eg. 10') }}"
                                class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label
                                for="long_term_limit">{{ translate('Limitation for Long Term Project Posting') }}</label>
                            <input type="number" min="0" step="1" id="long_term_limit" name="long_term_limit"
                                value="{{ $package->long_term_limit }}" required
                                placeholder="{{ translate('Eg. 10') }}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="bio_text_limit">{{ translate('Bio Word Limit') }}</label>
                            <input type="number" min="0" step="1" id="bio_text_limit" name="bio_text_limit"
                                value="{{ $package->bio_text_limit }}" required
                                placeholder="{{ translate('Eg. 120') }}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="following_status">{{ translate('Enable Expert Following ?') }}</label>
                            <div>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" @if ($package->following_status == '1') checked @endif
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" @if ($package->active == '1') checked @endif
                                        name="active">
                                    <span></span>
                                </label>
                            </div>
