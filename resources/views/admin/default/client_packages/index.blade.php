                            ...
                            @foreach ($packages as $key => $package)
                                <tr>
                                    ...
                                    <td>{{ count(\App\Models\PackagePayment::where('package_id', $package->id)->get()) }}
                                        {{ translate('times') }}</td>
                                    <td><img class="img-md" src="{{ my_asset($package->badge) }}" height="45px"
                                            alt="{{ translate('badge') }}"></td>
                                    ...
                                    <td><img class="img-md" src="{{ my_asset($package->photo) }}" height="45px"
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            href="{{ route($package->type . '_package.edit', encrypt($package->id)) }}"
