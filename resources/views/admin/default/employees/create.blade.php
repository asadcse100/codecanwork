                    ...
                    <form class="form-horizontal" action="{{ route('employees.store') }}" method="POST"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="street" name="street" required
                                placeholder="{{ translate('Eg. Street') }}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="phone">{{ translate('Phone') }}</label>
                            <input type="number" id="phone" name="phone" required
                                placeholder="{{ translate('Eg. 015XXXXXXXX') }}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="designation">{{ translate('Designation') }}</label>
                            <select class="form-control aiz-selectpicker" name="designation" id="designation"
