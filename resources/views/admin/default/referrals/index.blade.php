                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="switch-option-value" type="hidden" name="system" value="{{ sys_settings('referral_system') ?? 'no' }}">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="enable-referral-system" name="system" value="{{ sys_settings('referral_system') ?? 'no' }}">
                                                    <label class="form-check-label" for="enable-referral-system">{{ __('Enable') }}</label>
                                                </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" data-switch="yes"{{ (sys_settings('referral_show_referred_users', 'no') == 'yes') ? ' checked=""' : ''}}>
                                                    <label class="form-check-label" for="flexSwitchCheckChecked">{{ __('Enable') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-sets gy-3 wide-md">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control form-control-sm" id="invite-title" name="invite_title" value="{{ sys_settings('referral_invite_title') }}">
                                                </div>
                                                <div class="form-note">
                                                    {{ __('Eg. Refer Us & Earn') }}
                                                </div>
                                    ...
                                    <div class="row g-3 align-start">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control form-control-sm" id="invite-text" name="invite_text" value="{{ sys_settings('referral_invite_text') }}">
                                                </div>
                                                <div class="form-note">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" data-switch="yes"{{ (sys_settings('referral_signup_referer', 'no') == 'yes') ? ' checked=""' : ''}}>
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">{{ __('Allowed') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap w-max-250px">
                                                    ...
                                                    <input type="number" id="referer-signup-bonus-amount" class="form-control form-control-sm" name="signup_referer_bonus" value="{{ sys_settings('referral_signup_referer_bonus', '0') }}" min="0">
                                                </div>
                                ...
                                <div class="form-sets gy-3 wide-md">
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" name="deposit_referer" value="{{ sys_settings('referral_deposit_referer') ?? 'no' }}">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckChecked">{{ __('Allowed') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="row gx-1 gy-1">
                                                <div class="col-6 w-max-250px">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <select class="form-select form-control-sm" name="deposit_referer_allow" id="referer-deposit-bonus-allowed">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap w-max-100px">
                                                            <input type="number" placeholder="2" class="form-control form-control-sm" name="deposit_referer_max" value="{{ sys_settings('referral_deposit_referer_max', '') }}" min="2">
                                                        </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="row gx-1 gy-1 w-max-250px">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="number" id="referer-deposit-bonus-amount" class="form-control form-control-sm" name="deposit_referer_bonus" value="{{ sys_settings('referral_deposit_referer_bonus', '0') }}" min="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <select class="form-select form-control-sm" name="deposit_referer_type">
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="signup_user" value="{{ sys_settings('referral_signup_user') ?? 'no' }}">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">{{ __('Allowed') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3 align-start">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap w-max-250px">
                                                    <div class="form-text-hint"><span>{{ base_currency() }}</span></div>
                                                    <input type="number" id="user-signup-bonus-amount" class="form-control form-control-sm" name="signup_user_bonus" value="{{ sys_settings('referral_signup_user_bonus', '0') }}" min="0">
                                                </div>
                                            ...
                                            <div class="form-group mt-n2">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="signup_user_reward" value="{{ sys_settings('referral_signup_user_reward') ?? 'no' }}">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">{{ __('Do not apply the main signup bonus.') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="deposit_user" value="{{ sys_settings('referral_deposit_user') ?? 'no' }}">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">{{ __('Allowed') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="row gx-1 gy-1">
                                                <div class="col-6 w-max-250px">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <select class="form-select form-control-sm" name="deposit_user_allow" id="user-deposit-bonus-allowed">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap w-max-100px">
                                                            <input type="number" placeholder="2" class="form-control form-control-sm" name="deposit_user_max" value="{{ sys_settings('referral_deposit_user_max', '') }}" min="2">
                                                        </div>
                                                        <div class="form-note">{{ __('Number') }}</div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="row gx-1 gy-1 w-max-250px">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="number" id="user-deposit-bonus-amount" class="form-control form-control-sm" name="deposit_user_bonus" value="{{ sys_settings('referral_deposit_user_bonus', '0') }}" min="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
