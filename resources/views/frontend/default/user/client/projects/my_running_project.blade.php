                        ...
                        @if ($project->project_user != null)
                            <div class="card project-card">
                                <div class="card-header border-bottom-0">
                                    ...
                                    <div>
                                        <span
                                            class="badge badge-success badge-inline badge-md">{{ translate('Running') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('expert.details', $project->project_user->user->user_name) }}"
                                            ...
                                            <div class="pl-2">
                                                <h4 class="fs-14 mb-1">{{ $project->project_user->user->name }}
                                                </h4>
                                                <div class="">
                                    ...
                                    <div>
                                        <a href="javascript:void(0)" class="btn btn-secondary btn-sm fw-500 confirm-cancel"
                                            data-href="{{ route('projects.cancel', $project->id) }}">{{ translate('Cancel Project') }}</a>
                                        <a href="javascript:void(0)" class="btn btn-primary btn-sm fw-500 confirm-complete"
