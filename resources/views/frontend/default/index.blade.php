    ...
    <section class="hero">
        <div class="p-5">
            <div class="hero-inner">
                <div class="hero-copy">
                    <h1 class="hero-title">{{ get_setting('slider_section_title') }}</h1>
                    <p class="hero-paragraph">{!! get_setting('slider_section_subtitle') !!}</p>
                    <div class="hero-cta">
                        <a href="{{ route('register') }}?type=2" class="btn btn-outline-primary rounded-1">{{ translate('I want to Hire') }}</a>
                        <a href="{{ route('register') }}?type=1" class="btn btn-outline-primary rounded-1">{{ translate('I want to Work') }}</a>
                    </div>
                </div>
                <div class="hero-media">
                    <div class="header-illustration">
                        <img class="header-illustration-image asset-light" src="{{ asset('templete') }}/dist/images/header-illustration-light.svg" alt="Header illustration">
                        <img class="header-illustration-image asset-dark" src="{{ asset('templete') }}/dist/images/header-illustration-dark.svg" alt="Header illustration">
                    </div>
                    <div class="hero-media-illustration">
                        <img class="hero-media-illustration-image asset-light" src="{{ asset('templete') }}/dist/images/hero-media-illustration-light.svg" alt="Hero media illustration">
                        <img class="hero-media-illustration-image asset-dark" src="{{ asset('templete') }}/dist/images/hero-media-illustration-dark.svg" alt="Hero media illustration">
                    </div>
                    <div class="hero-media-container">
                        <img class="hero-media-image asset-light" src="{{ asset('templete') }}/dist/images/hero-media-light.svg" alt="Hero media">
                        <img class="hero-media-image asset-dark" src="{{ asset('templete') }}/dist/images/hero-media-dark.svg" alt="Hero media">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="features-inner section-inner has-bottom-divider">
                <div class="features-header text-center">
                    <div class="container-sm">
                        <h2 class="section-title mt-0">{{ get_setting('how_it_works_title') }}</h2>
                        <p class="section-paragraph">{{ get_setting('how_it_works_subtitle') }}</p>
                        <div class="features-image">
                            <img class="features-illustration asset-dark" src="{{ asset('templete') }}/dist/images/features-illustration-dark.svg" alt="Feature illustration">
                            <img class="features-box asset-dark" src="{{ asset('templete') }}/dist/images/features-box-dark.svg" alt="Feature box">
                            <img class="features-illustration asset-dark" src="{{ asset('templete') }}/dist/images/features-illustration-top-dark.svg" alt="Feature illustration top">
                            <img class="features-illustration asset-light" src="{{ asset('templete') }}/dist/images/features-illustration-light.svg" alt="Feature illustration">
                            <img class="features-box asset-light" src="{{ asset('templete') }}/dist/images/features-box-light.svg" alt="Feature box">
                            <img class="features-illustration asset-light" src="{{ asset('templete') }}/dist/images/features-illustration-top-light.svg" alt="Feature illustration top">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img class="asset-light" src="{{ asset('templete') }}/dist/images/feature-01-light.svg" alt="Feature 01">
                                <img class="asset-dark" src="{{ asset('templete') }}/dist/images/feature-01-dark.svg" alt="Feature 01">
                            </div>
                            <div class="feature-content">
                                <h3 class="feature-title mt-0">Discover</h3>
                                <p class="text-sm mb-0">{!! get_setting('how_it_works_description_1') !!}</p>
                            </div>
                        </div>
                    </div>
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img class="asset-light" src="{{ asset('templete') }}/dist/images/feature-02-light.svg" alt="Feature 02">
                                <img class="asset-dark" src="{{ asset('templete') }}/dist/images/feature-02-dark.svg" alt="Feature 02">
                            </div>
                            <div class="feature-content">
                                <h3 class="feature-title mt-0">Discover</h3>
                                <p class="text-sm mb-0">{!! get_setting('how_it_works_description_2') !!}</p>
                            </div>
                        </div>
                    </div>
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img class="asset-light" src="{{ asset('templete') }}/dist/images/feature-03-light.svg" alt="Feature 03">
                                <img class="asset-dark" src="{{ asset('templete') }}/dist/images/feature-03-dark.svg" alt="Feature 03">
                            </div>
                            <div class="feature-content">
                                <h3 class="feature-title mt-0">Discover</h3>
                                <p class="text-sm mb-0">{!! get_setting('how_it_works_description_3') !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="py-3 rounded-2 border-1 border-primary bg-hov-soft-primary">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="px-xl-5 px-md-3 mb-4 text-center">
                        <img src="{{ get_setting('how_it_works_banner_2') ? custom_asset(get_setting('how_it_works_banner_2')) : asset('assets/placeholder.jpg') }}" class="img-fluid mx-auto">
                        <div class="p-4">
                            @php
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="px-xl-5 px-md-3 mb-4 text-center">
                        <img src="{{ get_setting('how_it_works_banner_3') ? custom_asset(get_setting('how_it_works_banner_3')) : asset('assets/placeholder.jpg') }}" class="img-fluid mx-auto">
                        <div class="p-4">
                            @php
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-10 mx-auto">
                ...
                <a href="{{ route('project.details', $project->slug) }}" class="d-block card-project-rounded card mb-3 text-inherit">
                    <div class="row">
                        <div class="col-8">
        ...
        <div class="pt-4 text-center">
            <a href="{{ route('search') }}?keyword=&type=project" class="btn btn btn-primary rounded-1">{{ translate('Check All Projects') }}</a>
        </div>
    </div>
</section>
@endif
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active " id="nav-client">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('register') }}?type=2" class="btn bg-white text-primary hov-text-soft-primary rounded-1 mt-3">{{ translate('Or, Create an Account to Get Started') }}</a>
                                </div>
                            </div>
                            <div class="tab-pane fade " id="nav-freelancer">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('register') }}?type=1" class="btn bg-white text-primary rounded-1 mt-3">{{ translate('Or, Create an Account to Get Started') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
