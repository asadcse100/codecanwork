                ...
                <div class="col-xxl-9 col-xl-8 col-lg-7">
                    <div class="card project-card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="separator text-left mb-3"><span
                                    class="pr-3">{{ translate('Skills Required') }}</span></h6>
                            <div class="mb-5">
                                @foreach (json_decode($project->skills) as $key => $skill_id)
                                    ...
                                    @if ($skill != null)
                                        <a href="{{ route('search.skill', ['skill' => $skill_id, 'type' => 'projects']) }}"
                                            class="btn btn-outline-info btn-sm mb-1">{{ $skill->name }}</a>
                                    @endif
                                @endforeach
                            </div>
                            <h6 class="separator text-left mb-3"><span class="pr-3">{{ translate('Attachments') }}</span>
                            </h6>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card">
                                            <div class="card-header border-bottom-0 pt-4 pb-0 align-items-start minw-0">
                                                <div class="row">
                                                    <div class="col-sm-9">
                                                        <h5 class="h4 fw-600 lh-1-5 text-truncate-2 h-45px">
                                                            <strong><a
                                                                    href="{{ route('project.details', $similar_type_project->slug) }}"
                                                                    class="text-inherit"
                                                                    target="_blank">{{ $similar_type_project->name }}</a>
                                                            </strong>
                                                        </h5>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="flex-shrink-0 pl-3">
                                                            <span class="small">{{ translate('Budget') }}</span>
                                                            <h4 class="mb-0">
                                                                {{ single_price($similar_type_project->price) }}</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-1">
                                                ...
                                                <div class="text-muted lh-1-8">
                                                    <p class="text-truncate-2 h-50px mb-0 text-muted">
                                                        {{ $similar_type_project->excerpt }}</p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <a href="{{ route('client.details', $similar_type_project->client->user_name) }}"
                                                                target="_blank"
                                                                class="d-flex mr-3 align-items-center text-inherit">
                                                                <span class="avatar avatar-xs">
                                                                    @if ($similar_type_project->client->photo != null)
                                                                        <img
                                                                            src="{{ asset('profile/photos/' . $similar_type_project->client->photo) }}">
                                                                    @else
                                                                        <img src="{{ asset('assets/frontend/default/img/avatar-place.png') }}"
                                                                            class="rounded-circle">
                                                                    @endif
                                                                ...
                                                                <div class="pl-2">
                                                                    <h4 class="h6 mb-0">
                                                                        {{ $similar_type_project->client->name }}</h4>
