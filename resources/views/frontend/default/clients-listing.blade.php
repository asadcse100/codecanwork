    ...
    <div class="bg-light">
        <div class="container space-2">
                ...
                <div class="col-sm-8 col-md-6 text-sm-right">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <!-- Select -->
                            <select class="js-select selectpicker dropdown-select" data-width="fit"
                                ...
                                <div class="card-body px-3 py-4">
                                    ...
                                    <div class="mb-3">
                                        <div class="position-relative u-lg-avatar mx-auto mb-3">
                                            @if ($client->user->photo != null)
                                                <img src="{{ asset('profile/photos/' . $client->user->photo) }}">
                                            @else
                                    ...
                                    <div class="mb-3">
                                        <img class="max-width-4 mr-1"
                                            src="{{ my_asset('assets/frontend/svg/illustrations/top-level-award.svg') }}"
                                            alt="Image Description" title="Top Seller">
                                        <img class="max-width-4 mx-1"
                                            src="{{ my_asset('assets/frontend/svg/illustrations/verified-user.svg') }}"
                                            alt="Image Description" title="Verified user">
                                        <img class="max-width-4 ml-1"
                                            src="{{ my_asset('assets/frontend/svg/illustrations/top-endorsed.svg') }}"
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="d-none d-sm-inline-block text-secondary">{{ translate('Showing') }} {{ count($clients) }}
                    {{ translate('out of') }} {{ count($total_clients) }}</small>
            </div>
            <!-- End Pagination -->
        </div>
    </div>
