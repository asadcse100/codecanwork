        ...
        <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
            <div class="payment-methods layout-spacing ">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="list-group list-group-numbered">
                        <div class="list-group-item d-flex justify-content-between align-items-start">
                            <img src="{{ asset('templete') }}/src/assets/img/card-americanexpress.svg" class="align-self-center me-3" alt="americanexpress">
                            <div class="me-auto">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-start">
                            <img src="{{ asset('templete') }}/src/assets/img/card-mastercard.svg" class="align-self-center me-3" alt="mastercard">
                            <div class="me-auto">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-start">
                            <img src="{{ asset('templete') }}/src/assets/img/card-visa.svg" class="align-self-center me-3" alt="visa">
                            <div class="me-auto">
