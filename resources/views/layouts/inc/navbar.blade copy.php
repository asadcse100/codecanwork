    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 @if(!Auth::check()) layout-top-spacing mb-3 @endif">
                <header class="header navbar navbar-expand-sm expand-header">
                        ...
                        <form action="{{ route('search') }}" method="GET" class="flex-grows ">
                            <div class="input-group">
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                    <button class="btn btn-primary btn-sm" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button>
                                </div>
                    ...
                    <ul class="ms-lg-auto">
                        @if (!Auth::check())
                        <div class="lights-toggle ms-lg-auto">
                            <input id="lights-toggle" type="checkbox" name="lights-toggle" class="switch">
                            <label for="lights-toggle" class="text-xs"></label>
                        </div>
                        <!-- <div class="col-xl-3 col-lg-6 col-md-4 col-sm-5"> -->                        
                                <li class="nav-item d-none d-lg-block">
                                    <a class="btn btn-outline-primary rounded-1" href="{{ route('login') }}">{{ translate('Log In') }}</a>                                
                                </li>
                        <!-- </div>
                        <div class="col-xl-3 col-lg-12 col-md-4 col-sm-5">
                            <li class="nav-item d-none d-lg-block">
                                <a class="btn btn-primary rounded-1" href="{{ route('register') }}">{{ translate('Sign Up') }}</a>
                            </li>
                        </div> -->
                        @elseif (isAdmin())
                        <li class="nav-item d-none d-lg-block">
                                ...
                                <div class="notification-scroll">
                                    ...
                                    <div class="drodpown-title notification">
                                        ...
                                        <h6 class="d-flex justify-content-between">
                                            ...
                                            <span class="badge badge-secondary">{{ $unseen_chat_thread_count }}</span>
                                            @endif
                                        </h6>
                                    </div>
                                        ...
                                        <div class="media server-log">
                                            ...
                                            <a href="{{ route('all.messages') }}" class="chat-user-item p-3 d-block text-inherit hov-bg-soft-primary">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <img src="{{ asset($chat->chatThread->receiver->photo) }}">
                                                    @else
                                                    <img src="{{ asset('templete') }}/src/assets/img/demoprofile.png" class="img-fluid me-2" alt="avatar">
                                                    @endif
                                                    @if (Cache::has('user-is-online-' .
                                                    $chat->chatThread->receiver->id))
                                                    ...
                                                    <img src="{{ asset($chat->chatThread->sender->photo) }}">
                                                    @else
                                                    <img src="{{ asset('templete') }}/src/assets/img/demoprofile.png" class="img-fluid me-2" alt="avatar">
                                                    @endif
                            ...
                            <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                                <div class="notification-scroll">
                                    <div class="drodpown-title message">
                                        ...
                                        @php $noti_num =
                                        \App\Utility\NotificationUtility::get_my_notifications(10,true,true); @endphp
                                        @if ($noti_num != 0)
                                        <h6 class="d-flex justify-content-between"><span class="align-self-center">{{ translate('Notifications') }}</span>
                                    ...
                                    \App\Utility\NotificationUtility::get_my_notifications(10,false,false,false);
                                    @endphp
                                    ...
                                    <div class="dropdown-item">
                                        <div class="media server-log">
                                            ...
                                            <button class="btn btn-success rounded p-1" title="{{ translate('New') }}">
                            ...
                            <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="avatar-container">
                                    <div class="avatar avatar-sm avatar-indicators avatar-online mb-0">
                                        ...
                                        <img src="{{ asset('profile/photos/' . Auth::user()->photo) }}" class="rounded-circle">
                                        @else
                                        <img src="{{ asset('assets/frontend/default/img/demoprofile.png') }}" class="rounded-circle">
                                        @endif
                                    </div>
                                    ...
                                    <span class="ml-2 text-left d-none d-xl-inline-block">
                                        ...
                                        <span class="small fw-500 text-muted">
                                            @if (!empty(Auth::user()->profile->balance) &&
                                            isset(Auth::user()->profile->balance))
