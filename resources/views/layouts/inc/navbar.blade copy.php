            ...
            <header class="header navbar navbar-expand-sm expand-header">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                                <select class="form-select" name="type">
                                    <option value="expert" @isset($type) @if ($type=='expert' ) selected @endif
                                        @endisset>
                                        Experts</option>
                                    <option value="project" filter_category @isset($type) @if ($type=='project' )
                                        selected @endif @endisset>
                                        Project</option>
                                    <option value="service" @isset($type) @if ($type=='service' ) selected @endif
                                        @endisset>
                                        Services</option>
                                </select>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                <button class="btn btn-primary btn-sm" type="submit"><svg
                ...
                <ul class="ms-lg-auto">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a class="btn btn-outline-primary rounded-1" href="{{ route('login') }}">{{ translate('Log In')
                            }}</a>
                    </li>
                    <!-- </div>
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                            <div class="notification-scroll">
                                <div class="drodpown-title message">
                                    ...
                                    @if ($noti_num != 0)
                                    <h6 class="d-flex justify-content-between"><span class="align-self-center">{{
                                ...
                                @endforeach
                                <div class="border-top">
                                    <a href="{{ route('frontend.notifications') }}" class="text-center">{{
                                        translate('View All Notifications') }}</a>
                                </div>
                            </div>
                        </div>
                    </li>
